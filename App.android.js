...
*/
  ...
  <View style={{height:50, top:823, width:352, zIndex:3, flexDirection:'row', justifyContent:'space-around', left:25}}>
    ...
    <View style={{height:50, width:60, alignItems:'center'}}>
      ...
      <Image style={{height:25, width:25, left:-2}} source={{uri:"https://i.ibb.co/YtSRhCD/Cropped-Image-20220429-165534.png"}}></Image>
    ...
    <ScrollView>
      <View style={{height:50, backgroundColor:"#121212", top:20, justifyContent:'center'}}>
        <Text style={{color:"#ffffff", fontFamily:'Montserrat_700Bold', fontSize:20, left:10}}>Bonjour</Text>
        <Image style={{height:25, width:25, position:'absolute', left:250}} source={{uri:"https://i.ibb.co/nMX1wN1/Cropped-Image-20220429-135401.png"}}></Image>
        <Image style={{height:25, width:25, position:'absolute', left:295}} source={{uri:"https://i.ibb.co/wJX2XfG/Cropped-Image-20220429-135426.png"}}></Image>
        <Image style={{height:25, width:25, position:'absolute', left:340}} source={{uri:"https://i.ibb.co/b3zqKcS/Cropped-Image-20220429-135449.png"}}></Image>  
      </View>
      ...
      <View style={{height:180, backgroundColor:"#121212", top:25, marginLeft:20, marginRight:20}}>
        ...
        <View style={{width:175, height:55, backgroundColor:"#2f2f2f", borderRadius:4.5, position:'absolute', left:180, top:60, justifyContent:'center'}}>
        <Image style={{zIndex:2, height:55, width:55, position:'absolute', left:0, borderRadius:4.5}} source={{uri:"http://media.culturepsg.com/image/news/podcast_culturepsg.jpg"}}></Image>
          <Text style={{color:"#ffffff", fontFamily:'Montserrat_700Bold', fontSize:12, left:65, width:100}}>Podcast de CulturePSG</Text>
        </View>
        ...
        <View style={{width:175, height:55, backgroundColor:"#2f2f2f", borderRadius:4.5, position:'absolute', left:180, top:120, justifyContent:'center'}}>
        <Image style={{zIndex:2, height:55, width:55, position:'absolute', left:0, borderRadius:4.5}} source={{uri:"http://media.culturepsg.com/image/news/podcast_culturepsg.jpg"}}></Image>
          <Text style={{color:"#ffffff", fontFamily:'Montserrat_700Bold', fontSize:12, left:65, width:100}}>Podcast de CulturePSG</Text>
        </View>
      ...
      <View style={{top:75}}>
        ...
        <Text style={{color:"#ffffff", fontFamily:'Montserrat_700Bold', fontSize:22, left:15}}>Vos émissions</Text>
      ...
      <View style={{top:0}}>
        ...
        <Text style={{color:"#ffffff", fontFamily:'Montserrat_700Bold', fontSize:22, left:15}}>Vos mix préférés</Text>
